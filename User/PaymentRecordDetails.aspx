        ...
        $(document).ready(function () {
                    ...
                    $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'Status', datafield: 'Status', width: 80, cellsrenderer: statusRender },
                    { text: 'Payment Date', datafield: 'PaymentDate', width: 140, cellsformat: 'd' },
      ...
      <div id="content" class="span10">
        ...
        <div>
            <ul class="breadcrumb">
                ...
                <li><a href="#">Recharged history</a> </li>
            </ul>
        </div>
        <div class="row-fluid sortable">
            <div class="box span12">
                <div class="box-header well" data-original-title>
                    <h2>
                        <i class="icon-edit"></i>Recharged History</h2>
                    <div class="box-icon">
